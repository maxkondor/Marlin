...
#define STRING_CONFIG_H_AUTHOR "(Max Kondor)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Phoenix MK1"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 40, 40, 200, 98 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -27.75, -33, -2.1 }
